...
namespace Server
{
    ...
    {
        private readonly List<PlayerServerInfo> playerInfos = new();
        private readonly Dictionary<BoltConnection, PlayerServerInfo> playerInfosByConnection = new();
        private readonly Dictionary<ulong, PlayerServerInfo> playerInfosByPlayerId = new();
        ...
        public override void DoUpdate(int deltaTime)
        {
            ...
            for (var i = playerInfos.Count - 1; i >= 0; i--)
            {

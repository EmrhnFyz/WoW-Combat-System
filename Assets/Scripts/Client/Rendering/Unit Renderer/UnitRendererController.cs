...
namespace Client
{
    public partial class RenderingReference
    {
        ...
        private class UnitRendererController
        {
            ...
            private readonly HashSet<Unit> detachedUnits = new();
            ...
            public void Initialize()
            {
                ...
                EventHandler.SubscribeEvent<WorldEntity, bool>(rendering.World, GameEvents.ServerVisibilityChanged, OnServerVisibilityChanged);
            }

            public void Deinitialize()
            {
                EventHandler.UnsubscribeEvent<WorldEntity, bool>(rendering.World, GameEvents.ServerVisibilityChanged, OnServerVisibilityChanged);
                rendering.World.UnitManager.EventEntityAttached -= OnEventEntityAttached;
                rendering.World.UnitManager.EventEntityDetach -= OnEventEntityDetach;
            ...
            public void DoUpdate(float deltaTime)
            {
                ...
                for (var i = fadingModels.Count - 1; i >= 0; i--)
                {
            ...
            {
                for (var i = unitRenderers.Count - 1; i >= 0; i--)
                {
            ...
            {
                UnitRenderer unitRenderer = GameObjectPool.Take(unitRendererPrototype);

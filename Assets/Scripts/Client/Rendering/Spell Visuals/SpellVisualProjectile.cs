        ...
        private partial class SpellVisualController
        {
            private class SpellVisualProjectile
            {
                ...
                public bool HandleLaunch(UnitRenderer caster)
                {
                    ...
                    projectile = Settings.EffectSettings.PlayEffect(Vector3.zero, Quaternion.LookRotation(forward), out var newPlayId);
                ...
                public bool DoUpdate()
                {
                    ...
                    var ratio = (float)(BoltNetwork.ServerFrame - ServerLaunchFrame) / ExpectedDelayFrames;

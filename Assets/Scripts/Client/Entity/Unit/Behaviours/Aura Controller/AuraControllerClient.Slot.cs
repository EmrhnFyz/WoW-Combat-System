    ...
    public partial class AuraControllerClient
    {
        private class Slot : IVisibleAura
        {
            ...
            public void SetState(VisibleAuraState state)
            {
                ...
                var oldAuraId = AuraId;
                var oldRefrechFrame = ServerRefreshFrame;
                ...
                var expectedCooldownFrames = (int)(RefreshDuration / BoltNetwork.FrameDeltaTime / TimeUtils.InMilliseconds);
                var framesPassed = BoltNetwork.ServerFrame - ServerRefreshFrame;

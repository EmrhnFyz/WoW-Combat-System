...
namespace Client
{
    ...
    public class WarcraftCamera : MonoBehaviour
    {
        ...
        [SerializeField] private float deadTargetHeight = 0.5f;
        ...
        [SerializeField] private float targetHeightDampening = 3.0f;
        [SerializeField] private float rotationDampening = 3.0f;
        [SerializeField] private float zoomDampening = 5.0f;
        [SerializeField] private float targetSmoothTime = 0.05f;
        ...
        private void LateUpdate()
        {
            ...
            if (GUIUtility.hotControl == 0)
            {
                ...
                else if (!Mathf.Approximately(Input.GetAxis("Vertical"), 0) || !Mathf.Approximately(Input.GetAxis("Horizontal"), 0))
                {
                    ...
                    {
                        var targetRotationAngle = target.transform.eulerAngles.y;
            ...
            // set camera rotation
            var rotation = Quaternion.Euler(yDeg, xDeg, 0);

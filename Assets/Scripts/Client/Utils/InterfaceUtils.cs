...
namespace Client
{
    public static class InterfaceUtils
    {
        ...
        public static char[] SetSpellTimerNonAlloc(this char[] charArray, int milliseconds, out int length)
        {
            ...
            {
                var dayCount = milliseconds / TimeUtils.DayInMilliseconds;
                if (dayCount > 9)
                {
                    length = 3;
                    charArray[0] = '9';
            ...
            {
                var hourCount = milliseconds / TimeUtils.HourInMilliseconds;
                if (hourCount > 9)
                {
                    length = 3;
            ...
            {
                var minuteCount = milliseconds / TimeUtils.MinuteInMilliseconds;
                if (minuteCount > 9)
                {
                    length = 3;
            ...
            {
                var secondCount = milliseconds / TimeUtils.SecondInMilliseconds;
                if (secondCount > 9)
                {
                    length = 2;

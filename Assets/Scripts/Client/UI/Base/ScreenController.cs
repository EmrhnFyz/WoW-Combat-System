...
namespace Client.UI
{
    ...
    {
        private readonly List<UIPanelController> panelControllers = new();
        private readonly List<IScreenHandler> screenHandlers = new();
        private readonly Dictionary<Type, UIPanelController> panelControllersByPanelType = new();
        ...
        {
            foreach (UIPanelController panelController in panelControllers)
            {
        ...
        {
            foreach (IScreenHandler screenHandler in screenHandlers)
            {

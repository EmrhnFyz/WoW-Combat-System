...
namespace Client
{
    ...
    public partial class CustomDropdown : Selectable, IPointerClickHandler, ISubmitHandler, ICancelHandler
    {
        ...
        [SerializeField] private OptionDataList options = new();
        ...
        protected GameObject CreateBlocker(Canvas rootCanvas)
        {
            ...
            var newBlocker = new GameObject("Blocker");
        ...
        public void Show()
        {
            if (!IsActive() || !IsInteractable() || dropdown != null)
            {
                return;
            }

            // Get root Canvas.
            List<Canvas> list = ListPoolContainer<Canvas>.Take();
            ...
            var dropdownRectTransform = (RectTransform)dropdown.transform;
            ...
            var contentRectTransform = (RectTransform)content.transform;

...
namespace Client
{
    ...
    {
        [SerializeField] private TooltipSettingsBySizeDictionary tooltipSizeSettings;
        [SerializeField] private TooltipSettingsByAlignmentDictionary tooltipAlignmentSettings;

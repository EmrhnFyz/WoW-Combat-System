...
namespace Core
{
    public static class UnitUtils
    {
        ...
        private static readonly Dictionary<EmoteType, bool> EmoteStateInfo = new()
        {
            {EmoteType.Beg, false},
            {EmoteType.Bow, false},
        ...
        private static readonly HashSet<ClassType> PlayerClasses = new(Enum.GetValues(typeof(ClassType)).Cast<ClassType>());

        public static bool IsOneShot(this EmoteType emoteType) => EmoteStateInfo.TryGetValue(emoteType, out var isState) && !isState;

        public static bool IsState(this EmoteType emoteType) => EmoteStateInfo.TryGetValue(emoteType, out var isState) && isState;

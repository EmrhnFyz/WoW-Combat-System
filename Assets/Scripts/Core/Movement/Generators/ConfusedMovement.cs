...
namespace Core
{
    ...
    {
        private TimeTracker nextMoveTime = new();
        private readonly NavMeshPath confusedNavMeshPath = new();
        ...
        {
            var cantMove = unit.HasAnyState(UnitControlState.Root | UnitControlState.Stunned | UnitControlState.Distracted);

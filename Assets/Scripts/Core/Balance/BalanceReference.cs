...
namespace Core
{
    ...
    public class BalanceReference : ScriptableReference
    {
        ...
        private readonly Dictionary<int, AuraInfo> auraInfosById = new();

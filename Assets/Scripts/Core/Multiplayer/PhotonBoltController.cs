...
namespace Core
{
    internal class PhotonBoltController : GlobalEventListener, IPhotonBoltController
    {
        ...
        private readonly ConnectionAttemptInfo connectionAttemptInfo = new();
        ...
        public override void BoltStartDone()
        {
            ...
            var hasServerLogic = networkingMode is NetworkingMode.Server or NetworkingMode.Both;
            var hasClientLogic = networkingMode is NetworkingMode.Client or NetworkingMode.Both;
        ...
        {
            return state is State.Inactive or State.Active;
        }
    }
}

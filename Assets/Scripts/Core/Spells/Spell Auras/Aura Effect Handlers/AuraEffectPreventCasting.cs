namespace Core.AuraEffects
{
    public class AuraEffectPreventCasting : AuraEffect
    {
        ...
        public override void HandleEffect(AuraApplication auraApplication, AuraEffectHandleMode mode, bool apply)
        {
            ...
            var hasSilence = EffectInfo.PreventionType.HasTargetFlag(SpellPreventionType.Silence);
            var hasPacify = EffectInfo.PreventionType.HasTargetFlag(SpellPreventionType.Pacify);

...
namespace Core
{
    public sealed class Map
    {
        ...
        internal Map(World world, Scene mapScene)
        {
            ...
            foreach (GameObject rootObject in mapScene.GetRootGameObjects())
            {
            ...
            {
                foreach (Scenario.ScenarioAction scenarioAction in Settings.ScenarioActions)
                {
        ...
        {
            var hitCount = Physics.OverlapSphereNonAlloc(center, radius, raycastResults, PhysicsReference.Mask.Characters);

...
namespace Core
{
    public abstract partial class Unit
    {
        internal class MotionController : IUnitBehaviour
        {
            ...
            private readonly IdleMovement idleMovement = new();
            ...
            internal void SimulateOwner()
            {
                ...
                {
                    var shouldIgnore = BoltNetwork.ServerFrame < remoteControlGainFrame + IgnoredFramesAfterControlGained;
                    if (!shouldIgnore)
                    {
            ...
            {
                var newMovementIndex = (int)newMovementSlot;
            ...
            {
                var cancelledIndex = (int)cancelledMovementSlot;
